...
export default function TaskSectionCompleted({ section, openUpdateModal }) {
  ...
  return (
      <Col>
        <Badge className='w-100 backgroundGray mainTxt d-flex justify-content-start mb-3'>
          ...
          <div style={custStyle.toDoImgWrap}><img src={greenToDo} alt="To Do Gray" className="w-100" /> </div>                  
          <p style={custStyle.toDoLable} className='mb-0'>Completed</p> 
          </Col>
